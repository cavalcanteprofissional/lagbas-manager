...
CREATE INDEX IF NOT EXISTS idx_cilindro_compartilhado ON cilindro(compartilhado);
CREATE INDEX IF NOT EXISTS idx_elemento_compartilhado ON elemento(compartilhado);
CREATE INDEX IF NOT EXISTS idx_amostra_compartilhado ON amostra(compartilhado);
