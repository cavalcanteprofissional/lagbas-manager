...
CREATE INDEX idx_cilindro_compartilhado ON cilindro(compartilhado);
CREATE INDEX idx_elemento_compartilhado ON elemento(compartilhado);
CREATE INDEX idx_amostra_compartilhado ON amostra(compartilhado);
