...
\begin{figure}[h!]
\centering
\includegraphics[width=0.9\textwidth]{figuras/figura1_arquitetura}
...
%\subsection{3.2.1 Abas Disponíveis}
...
%\subsection{3.2.2 Fluxo de Navegação}

A navegação entre as abas do sistema é realizada através de um \textbf{menu lateral (sidebar)}, que exibe dinamicamente apenas as abas permitidas para o usuário logado. O Dashboard funciona como página inicial e ponto central de acesso.

\begin{figure}[h!]
\centering
\includegraphics[width=0.9\textwidth]{figuras/figura2_navegacao}
...
%\subsection{3.2.3 Sistema de Controle de Permissões}
...
\lstinputlisting[language=JSON, caption=JSON de Permissões]{codigo/permissoes.json}
...
%\subsubsection{3.3.1 Sistema de Auditoria e Registro de Log}
...
\textbf{https://github.com/cavalcanteprofissional/lagbas-manager}
